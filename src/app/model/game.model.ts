  ...
  party: Party = new Party([
    ...
    [
      new Character('Faren', CreatureClass.ARCHER, 4, 30, false, 50, 8, [
          ...
          new Execution([SkillIconType.ATTACK], 'Final Shot', SkillTargetType.OTHER_ALIVE, 10, 1, 1,
      ...
      new Character('Harika', CreatureClass.MAGE, 4, 30, true, 50, 8, [
          ...
          new Drain([SkillIconType.ATTACK, SkillIconType.HEAL], 'Drain Life', SkillTargetType.OTHER_ALIVE, 10, 1, 1,
