...
export class Game {
  ...
  party: Party = new Party([
      new Character('Melkan', CreatureClass.WARRIOR, 4, 30, false, 50, 8, [
          ...
          new DamageAndBleed(SkillIconType.ATTACK, 'Deep Wound', SkillTargetType.OTHER_ALIVE, 20, 1, 1,
            'Inflict 50% damage to the target and 120% damage over ' + Constants.EFFECT_DURATION + ' rounds.', [0.5, 0.4]),
          new Damage(SkillIconType.ATTACK, 'Slash', SkillTargetType.OTHER_ALIVE_DOUBLE, 20, 1, 1,
      ...
      new Character('Arwin', CreatureClass.PALADIN, 4, 30, true, 50, 8, [
          ...
          new Damage(SkillIconType.ATTACK, 'Holy Strike', SkillTargetType.OTHER_ALIVE, 5, 1, 1,
            'Inflict 100% damage.'),
          new DamageAndHeal(SkillIconType.ATTACK, 'Recovery Strike', SkillTargetType.OTHER_ALIVE, 10, 1, 1,
          ...
          new DualHeal(SkillIconType.HEAL, 'Dual Heal', SkillTargetType.SAME_ALIVE_OTHER, 10, 0, 1,
          ...
          new Heal(SkillIconType.HEAL, 'Heal All', SkillTargetType.SAME_ALIVE_ALL, 20, 0, 1,
            'Heal all characters for 50% damage.', [0.5]),
          new Revive(SkillIconType.HEAL, 'Revive', SkillTargetType.SAME_DEAD, 20, 0, 1,
    ...
    [
      ...
      new Character('Harika', CreatureClass.MAGE, 4, 30, true, 50, 8, [
          ...
          new Damage(SkillIconType.ATTACK, 'Lightning', SkillTargetType.OTHER_ALIVE, 5, 2, 1,
            'Inflict 100% damage.'),
          new Damage(SkillIconType.ATTACK, 'Fireball', SkillTargetType.OTHER_ALIVE_TRIPLE, 10, 2, 1,
            'Inflict 60% damage to three adjacent targets.', [0.6]),
