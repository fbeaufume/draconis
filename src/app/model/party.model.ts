...
export class StandardParty extends Party {
  ...
  constructor() {
    super([
        new Character('Melkan', CreatureClass.WARRIOR, 4, 30, false, 3, 8, [
            new DefendTech(),
            ...
            new ApplyDeterioration('Intimidate', SkillTargetType.OTHER_ALIVE, 2, false, 1, 1,
      ...
      [
        new Character('Faren', CreatureClass.ARCHER, 4, 30, false, 3, 8, [
            new DefendTech(),
            new Shot('Shot', ElementType.PHYSICAL, 'Inflict 100% physical damage to the target.'),
            new DamageAndDot('Viper Shot', SkillTargetType.OTHER_ALIVE, 1, false, 2, 1,
